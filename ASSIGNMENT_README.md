# Distributed Blockchain Indexer

## Overview

You will build a distributed blockchain indexing system where multiple scraper instances coordinate to extract block data from a shared RPC endpoint.
...
- Document your schema design choices
 ...
 POSTGRES_URL=postgresql://user:pass@localhost:5432/indexer
...
1. **Source code** in `src/` implementing the scraper
